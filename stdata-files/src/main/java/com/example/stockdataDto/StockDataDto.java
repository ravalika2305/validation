package com.example.stockdataDto;
...
public class StockDataDto {
    ...
    public StockDataDto(Integer id, String companyCode, Integer t1, Integer t2, Integer t3, String stockOrderType) {
        this.id = id;
	...
	public String toString() {
		return "StockDataDto [id=" + id + ", companyCode=" + companyCode + ", t1=" + t1 + ", t2=" + t2 + ", t3=" + t3
